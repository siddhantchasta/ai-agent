...
1. google_books:
   - When calling GraphQL tools like google_books, always inline literal argument values directly in the query string (e.g. books(q: "term", maxResults: 5)). Do not declare GraphQL $variables — they are not supported by this tool. If a tool call fails, do not retry more than once; report the failure to the user directly.
